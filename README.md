...
*Correção (motilidade x FEVE — fundamentada na literatura, aprovada pela Dra.):*
- Quando a FEVE está reduzida, a motilidade passa a ser tratada como **alterada** automaticamente (pesquisa em diretrizes ASE/WMSI: FEVE reduzida implica contração anormal — regional **ou** difusa; não existe "todos os segmentos normais" com FEVE baixa). Se nenhum segmento regional for marcado, o texto sai como **"Hipocinesia difusa. Disfunção sistólica [grau] (FEVE= X% pelo método de Y)."** (redação da Dra.), no lugar do antigo "contratilidade segmentar preservada e função reduzida". Se ela marcar segmentos, o texto regional segue como antes. Laudo normal (FEVE preservada) **inalterado**.
